...
/* package Haskell-Stuff-0.1.0.0 */
#ifndef VERSION_Haskell_Stuff
#define VERSION_Haskell_Stuff "0.1.0.0"
#endif /* VERSION_Haskell_Stuff */
#ifndef MIN_VERSION_Haskell_Stuff
#define MIN_VERSION_Haskell_Stuff(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Haskell_Stuff */
...
#define CURRENT_COMPONENT_ID "Haskell-Stuff-0.1.0.0-inplace-Haskell-Stuff"
